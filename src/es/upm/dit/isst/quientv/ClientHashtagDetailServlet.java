...
public class ClientHashtagDetailServlet extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		resp.setContentType("text/plain");
		
		// Id del hashtag recibido como parámetro en la URL
		String encriptHId = req.getParameter("id");
		
		String hashtagId = "";
		try {
			hashtagId = Utilities.desencriptar(encriptHId.replace(' ','+'));
		} catch (Exception e) {
		...
		String encriptarHId = Utilities.encriptar(hashtagSelected.getId());
		hashtagSelected.setId(encriptarHId);
		req.setAttribute("hashtag", hashtagSelected);
		
		//Encriptamos el id de búsqueda para el cliente
		String encriptado = Utilities.encriptar(hashtagSelected.getBusquedaId());
		req.setAttribute("client", encriptado);
